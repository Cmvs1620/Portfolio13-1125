...
const Hero3D = lazy(() => import("./Hero3D").catch(err => {
          ...
          >
            ...
            <motion.div className="flex-1 flex justify-center lg:justify-end w-full" variants={itemVariants}>
              <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl">
                <Suspense fallback={
                  <div className="w-full h-[360px] sm:h-[420px] lg:h-[500px] bg-gradient-to-br from-primary/20 to-purple-600/20 rounded-2xl flex items-center justify-center border border-primary/20 animate-pulse">
